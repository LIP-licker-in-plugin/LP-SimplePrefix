...
public class DSPFunction {
    ...
    public static void showPrefixList(Player p) {
        ...
        ItemStack pane = NBT.setStringTag(new ItemStack(Material.STAINED_GLASS_PANE), "page", "true");
        ItemStack prev = NBT.setStringTag(new ItemStack(Material.INK_SACK, 1, (short) 6), "prev", "true");
        ...
        prev.setItemMeta(im);
        ItemStack next = NBT.setStringTag(new ItemStack(Material.INK_SACK, 1, (short) 7), "next", "true");
        im = next.getItemMeta();
